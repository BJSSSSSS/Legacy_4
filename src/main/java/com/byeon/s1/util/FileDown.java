...
import com.byeon.s1.file.FileDTO;
import com.byeon.s1.member.MemberFileDTO;
...
//AbstractView 란??
	...
	@Override    //render                  // 여기 model에 modelandview에 담은게 담긴다!
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		//MemberFileDTO memberFileDTO = (MemberFileDTO)model.get("file");
		//한꺼번에 처리하기위해 fileDTO로 상속받아서 사용하도록 변환
		...
		//매개변수 request가 있음(이 메서드안에 선언되어 있기때문에 이렇게도 선언 가능!)
